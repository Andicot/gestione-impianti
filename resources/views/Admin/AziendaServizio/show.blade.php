...
@section('content')
    <div class="row">
        <div class="col-lg-4">
            @include('Admin.AziendaServizio.show.sideBar')
        </div>
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content" id="tabContent">
                        <div class="tab-pane fade show active" role="tabpanel">
                            ...
                            @include('Admin.AziendaServizio.show.tab'.Str::of($tab)->remove('tab_')->title()->remove('_'))
...
@push('customScript')
    <script>
        ...
        $(function(){
            eliminaHandler('Questa azienda di servizio verrà eliminata definitivamente');
