                ...
                <td class="text-end">
                    ...
                    <div
                        ...
                        <div class="menu-item px-3">
                            <a href="{{action([\App\Http\Controllers\Backend\AmministratoreController::class,'show'],$amministratore->id)}}"
                               class="menu-link px-3">
                                Visualizza
                            </a>
                        </div>
                        <div class="menu-item px-3">
                            <a href="{{action([\App\Http\Controllers\Backend\AmministratoreController::class,'edit'],$amministratore->id)}}"
                               class="menu-link px-3">
                                Modifica
                            </a>
                        </div>
