...
@section('content')
    <div class="row">
        <div class="col-lg-4">
            @include('Aziendadiservizio.Amministratore.show.sideBar')
        </div>
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content" id="tabContent">
                        <div class="tab-pane fade show active" role="tabpanel">
                            ...
                            @include('Aziendadiservizio.Amministratore.show.tab'.Str::of($tab)->remove('tab_')->title()->remove('_'))
...
@push('customScript')
    <script>
        $(function(){
            eliminaHandler('Questo amministratore  verrà eliminata definitivamente');
