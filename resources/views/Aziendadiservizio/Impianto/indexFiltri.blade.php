                ...
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="btn-group btn-group-sm w-100" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                            <label class="btn btn-sm btn-outline btn-color-muted btn-active-primary {{ request('filtro_rapido') == 'attivi' ? 'active' : '' }}" data-kt-button="true">
                                <input class="btn-check" type="radio" name="filtro_rapido" value="attivi"
                                    {{ request('filtro_rapido') == 'attivi' ? 'checked' : '' }}/>
                                Solo Attivi
                            </label>

                            <label class="btn btn-sm btn-outline btn-color-muted btn-active-success {{ request('filtro_rapido') == 'con_concentratore' ? 'active' : '' }}" data-kt-button="true">
                            ...
                            <label class="btn btn-sm btn-outline btn-color-muted btn-active-warning {{ request('filtro_rapido') == 'senza_concentratore' ? 'active' : '' }}" data-kt-button="true">
