        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{\App\storeUpdateHelper($controller,$record?->id)}}" onsubmit="return disableSubmitButton()">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        @include('Metronic._inputs_v.inputText',['campo'=>'telefono_ufficio', 'altro' => 'onkeypress="return ((event.charCode >= 48 && event.charCode <= 57) || event.charCode == 43)"'])
                    </div>
                    <div class="col-md-6">
                        @include('Metronic._inputs_v.inputText',['campo'=>'indirizzo_ufficio'])
                    </div>
                    <div class="col-md-6">
                        @include('Metronic._inputs_v.inputText',['campo'=>'cap_ufficio', 'altro' => 'onkeypress="return (event.charCode >= 48 && event.charCode <= 57)"'])
                    </div>
                    <div class="col-md-6">
                        @include('Metronic._inputs_v.inputSelect2',['campo'=>'citta_ufficio', 'selected'=>\App\Models\Comune::selected(old('citta_ufficio',$record->citta_ufficio))])
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-4 offset-md-4 text-center">
                        <button class="btn btn-sm btn-primary fw-bold" type="submit" id="submit">
                            {{$vecchio?'Salva modifiche':'Crea '.\App\Models\Amministratore::NOME_SINGOLARE}}
                        </button>
                    </div>
                    @if($vecchio)
...
@push('customScript')
    ...
    <script>
        $(function () {
            ...
            select2Citta('citta_ufficio', 'il Citta ufficio', 1, 'citta');
        });
    </script>
@endpush
