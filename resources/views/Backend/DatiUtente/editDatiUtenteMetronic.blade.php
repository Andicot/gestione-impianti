...
@section('content')
    @includeWhen(session()->has('message'),'Metronic._components.alertMessage')
    <div class="card">
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade {{$activeTab === 'dati-utente' ? 'active show' : ''}}" id="tab_dati" role="tabpanel">
                    ...
                    <form method="POST" action="{{ action([$controller,'update'],'dati-utente') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                @include('Metronic._inputs_v.inputText',['campo'=>'cognome','placeholder'=>'Il tuo cognome','required'=>true,'autocomplete'=>'family-name'])
                            </div>
                            <div class="col-md-6">
                                @include('Metronic._inputs_v.inputText',['campo'=>'nome','placeholder'=>'Il tuo nome','required'=>true,'autocomplete'=>'given-name'])
                            </div>
                            <div class="col-md-6">
                                @include('Metronic._inputs_v.inputText',['campo'=>'telefono','placeholder'=>'Il tuo numero di telefono','required'=>false,'altro'=>'maxlength="16"'])
                            </div>
                        </div>
                        <div class="w-100 text-center">
                            <button class="btn bg-gray-800 btn-color-white mt-3 btn-active-dark" type="submit">Salva modifiche</button>
                        </div>
                    </form>
                </div>
                <div class="tab-pane fade {{$activeTab === 'dati-password' ? 'active show' : ''}}" id="tab_password" role="tabpanel">
                    ...
                    <form method="POST" action="{{ action([$controller,'update'],'dati-password') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                @include('Metronic._inputs_v.inputPassword',[
                        ...
                        <div class="w-100 text-center">
                            <button class="btn bg-gray-800 btn-color-white mt-3 btn-active-dark" type="submit">Modifica password</button>
                        </div>
                    </form>
                </div>
                <div class="tab-pane fade {{$activeTab === 'dati-email' ? 'active show' : ''}}" id="tab_email" role="tabpanel">
                    ...
                    <form method="POST" action="{{ action([$controller,'update'],'dati-email') }}">
                        ...
                        <div class="w-100 text-center">
                            <button class="btn bg-gray-800 btn-color-white mt-3 btn-active-dark" type="submit">Modifica email</button>
                        </div>
                    </form>
                </div>
            </div>
