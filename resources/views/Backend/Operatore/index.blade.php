    ...
    <div class="d-flex align-items-center py-1">
        ...
        @isset($ordinamenti)
            <div class="me-4 d-none d-md-block">
                <button class="btn btn-sm btn-icon btn-light btn-color-gray-700 btn-active-primary @if(\App\Http\HelperForMetronic::SIDEBAR) bg-body @endif" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end"
        ...
        @endisset
        <a class="btn btn-sm btn-primary fw-bold" data-targetZ="kt_modal" data-toggleZ="modal-ajax" href="{{action([$controller,'create'])}}">{{$testoNuovo}}</a>
    </div>
@endsection
@section('content')
    <div class="card pt-4">
        <div class="card-body pt-0 pb-5 fs-6 px-2 px-md-10" id="tabella">
            @include('Backend.Operatore.tabella')
        </div>
    </div>
@endsection
@push('customScript')
