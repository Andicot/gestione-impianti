...
<body id="kt_app_body"
      ...
      @else
          data-kt-app-layout="light-header" data-kt-app-header-fixed="true" data-kt-app-toolbar-enabled="true"
      class="app-default" data-kt-app-toolbar-fixed="true"
    @endif
...
<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
    ...
    <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
        ...
        <div id="kt_app_header" class="app-header ">
            ...
            <div
                class="app-container  {{\App\Http\HelperForMetronic::container()}} d-flex align-items-stretch justify-content-between "
                ...
                <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                    <a href="/" class="d-lg-none">
                        <img alt="Logo" src="/loghi/logo-placeholder.png" class="h-30px"/>
                    </a>
                </div>
                <!--end::Mobile logo-->
                ...
                <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                    ...
                    >
                        <!--begin::Menu-->
                        @includeWhen(\App\Http\HelperForMetronic::TOP_MENU,'Metronic._layout.app-header-menu')
                        <!--end::Menu-->
                    </div>
                    <!--end::Menu wrapper-->
                    <!--begin::Navbar-->
            ...
            <span class="menu-icon" data-kt-element="icon">
                ...
                System
                        ...
                        <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                            <!--begin::Menu wrapper-->
                            @include('Metronic._layout.user_account_menu')
                            <!--end::Menu wrapper-->
                        </div>
                        <!--end::User menu-->
                        @if(\App\Http\HelperForMetronic::TOP_MENU)
        ...
        <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
            @includeWhen(\App\Http\HelperForMetronic::SIDEBAR,'Metronic._layout.sidebar')
            <!--begin::Main-->
            <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    ...
                    >
                        ...
                        <div id="kt_app_toolbar_container"
                             class="app-container  {{\App\Http\HelperForMetronic::container()}} d-flex flex-stack ">
                            <!--begin::Page title-->
                            <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                ...
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
                                @includeWhen(isset($breadcrumbs),'Metronic._layout.breadcrumbs')
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Page title-->
                            <!--begin::Actions-->
                    ...
                    <div id="kt_app_content" class="app-content  flex-column-fluid ">
                        ...
                        <div id="kt_app_content_container"
                             class="app-container  {{\App\Http\HelperForMetronic::container()}} ">
                            @yield('content')
                        </div>
                ...
                <div id="kt_app_footer" class="app-footer ">
                    ...
                    <div
                        class="app-container  {{\App\Http\HelperForMetronic::container()}} d-flex flex-column flex-md-row flex-center flex-md-stack py-3 ">
                        <!--begin::Copyright-->
...
<!--end::App-->
@include('Metronic._layout.modal')
<!--begin::Scrolltop-->
