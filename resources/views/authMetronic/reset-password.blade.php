    ...
    <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
        ...
        <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="fv-row mb-10 fv-plugins-icon-container">
                ...
                <input class="form-control form-control-lg form-control-solid @error('email') is-invalid @enderror" type="email" id="email" name="email"
                       autocomplete="email"
            ...
            <div class="fv-row mb-10 fv-plugins-icon-container">
                ...
                <input class="form-control form-control-lg form-control-solid @error('password') is-invalid @enderror" type="password" id="password"
                       name="password"
            ...
            <div class="fv-row mb-10 fv-plugins-icon-container">
                ...
                <input class="form-control form-control-lg form-control-solid " type="password" id="password_confirmation" name="password_confirmation"
                       autocomplete="new-password">
            </div>
